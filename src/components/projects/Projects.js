		...
		<section className="projects" id="projects">
			...
			<div className="projects-container">
				<div className="projo weather">
					...
					<p className="projo-skills">Skills: HTML, CSS, Javascript</p>
				...
				<div className="projo to-do">
					...
					<p className="projo-des">
						...
						applications but the most important one when I was setting it up is
						to keep the user occupied especially when they are waiting for data
						to load. The game incorporates Redux for state management.
					</p>
					<a
				...
				<div className="projo porfolio-site">
					...
					<p className="projo-skills">
						Skills: HTML, CSS, Javascript, React, Context API
					</p>
					<p className="projo-des">
