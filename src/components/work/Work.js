  ...
  return (
    <section className="work">
      ...
      <div className="work-container">
        <div className="works">
          <h3 className="work-title"><i class="fa-solid fa-laptop-code"></i> Front-End Developer & Content Lead</h3>
          <h4 className="work-place"><i class="fa-solid fa-briefcase"></i> Tisini- Kenya</h4>
          <p className="date"><i class="fa-regular fa-clock"></i> February 2020- Present</p>
        ...
        <div className="works">
          <h3 className="work-title"><i class="fa-solid fa-laptop-code"></i> Front-End Engineer</h3>
          <h4 className="work-place"><i class="fa-solid fa-briefcase"></i>Freelance</h4>
          <p className="date"><i class="fa-regular fa-clock"></i> February 2022- Present</p>
