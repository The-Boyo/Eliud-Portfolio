...
const Header = ({ width }) => {
	...
	return (
		<header>
			<h4 className="title">EM</h4>
			<nav className="nav">
				<ul className="navbar" ref={navRef} onClick={displayNav}>
					<li>
						<a href="#home" className="navlink" id="home" onClick={displayNav}>
							Home
						</a>
					</li>
					<li>
						<a href="#about-me" className="navlink" onClick={displayNav}>
							About
						</a>
					</li>
					<li>
						<a href="#tech-skills" className="navlink" onClick={displayNav}>
							Skills
						</a>
					</li>
					<li>
						<a href="#work-experience" className="navlink" onClick={displayNav}>
							Experience
						</a>
					</li>
					<li>
						<a href="#projects" className="navlink" onClick={displayNav}>
							Projects
						</a>
					</li>
				</ul>
